...
Demonstrates weighted load distribution with 3 fixed-capacity analyzers (weights 0.1, 0.2, 0.3, 0.4) and shows that work naturally distributes proportionally (10%, 20%, 30%, 40%).
